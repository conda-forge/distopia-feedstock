...
Explicit SIMD vectorisation (provided by the Highway library https://github.com/google/highway)
allows awesome speedups over autovectorised code.
The distopia package consists of the python layer (distopia)
